...
!(function (t) {
  ...
  var i = t(window),
    ...
    M = t(".grid-filter"),
    m = i.width();
  if (((M = M.length > 0 ? M : t(".page-grid-filter")), o.length > 0))
    var g = o.offset().top;
  var f = {
    isMobile: {
      browser: {
  ...
  e.addClass("breakpoint-" + L),
              ...
              (r > g + a
                ? (o.addClass("header-sticky"),
                  r > g + s &&
                    ...
                    f.submenuLight && (o.removeClass("dark"), !0),
                    INSPIRO.header.logoStatus()))
                : (o.removeClass().addClass(n), INSPIRO.header.logoStatus()));
          }),
          t(window).breakpoints("lessThan", "lg", function () {
              ...
              t(window).breakpoints("lessThan", "lg", function () {
                f.menuIsOpen
                        ...
                        { "min-height": 0 },
                        {
                          start: function () {
                            ...
                            e.removeClass("mainMenu-open"),
                              ...
                              f.submenuLight && a && o.addClass("dark");
                          },
                          duration: 500,
                  ...
                  : void (
                      ...
                      ((r = !0),
                      (f.menuIsOpen = !0),
                      f.submenuLight && (o.removeClass("dark"), (a = !0)),
        ...
        d.length > 0 &&
          d.each(function () {
            t(this)
              ...
              .on("click", function () {
                d.toggleClass("page-menu-active"),
                  d.toggleClass("items-visible");
              });
          });
      },
          ...
          function r(e, a) {
            ...
            var n = i.height(),
              ...
              l =
                ...
                e.attr("data-height")),
              d =
                (e.attr("data-height-xs"),
                e.find(".container").first().outerHeight());
            if (d >= n) {
              !0;
              var c = d;
              e.css("min-height", c + 100),
                r.css("min-height", c + 100),
                e.find(".flickity-viewport").css("min-height", c + 100);
            }
            function u(t) {
              "null" == t
                ? (e.css("height", ""),
          ...
          c.each(function () {
            ...
            (i.options = {
              ...
              i.find(".slide").length <= 1 &&
                ((i.options.prevNextButtons = !1), (i.options.pageDots = !1)),
                    ...
                    r.each(function (i) {
                      ...
                      (function (t) {
                        t.find(".slide.is-selected").hasClass("slide-dark")
                          ? o.removeClass("dark").addClass("dark-removed")
                          : !o.hasClass("sticky-active") &&
                            o.hasClass("dark-removed") &&
                            o.addClass("dark").removeClass("dark-removed");
                      })(i),
                      n(i),
                      a(r);
                  },
                  select: function (e) {
                    t(this.selectedElement).find("video") &&
                      t(this.selectedElement)
                        .find("video")
                        .each(function (t, e) {
                          e.play(),
    ...
    (INSPIRO.elements = {
      ...
      naTo: function () {
        t(
          ...
          var i = 0,
            a = 0;
          m <= 991
            ? (o.find("#mainMenu").css("max-height", 0),
              e.toggleClass("mainMenu-open"),
              t("#mainMenu-trigger button").toggleClass("toggle-active"),
              !0 === o.attr("data-responsive-fixed") && (a = o.height()))
            : o.length > 0 && (a = o.height()),
          ...
          [].forEach.call(n, function (t) {
            ...
            e.hasClass("b--desktop")
              ? (o.setAttribute("preserveAspectRatio", "none"),
                i.options.height
                  ? o.setAttribute("style", "height:" + i.options.height + "px")
                  : o.setAttribute(
                      "style",
                      "height:" + o.height.baseVal.value + "px"
                    ))
        ...
        if (t(".countdown").length > 0) {
          ...
          t("[data-countdown]").each(function () {
            ...
            i.countdown(e, function (t) {
              i.html(
                t.strftime(
                  '<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>Day%!d</span></div><div class="countdown-box"><div class="number">%H</div><span>Hours</span></div><div class="countdown-box"><div class="number">%M</div><span>Minutes</span></div><div class="countdown-box"><div class="number">%S</div><span>Seconds</span></div></div>'
                )
              );
            });
          });
              ...
              a.append('<div class="grid-loader"></div>'),
                a.imagesLoaded().always(function () {
                  a
                    ...
                    .isotope("layout"),
                    a.on("layoutComplete", function (t, i) {
      ...
      gridLayoutInfinite: function (i, e, a) {
        ...
        if ((m = t(".infinite-scroll > a").attr("href")).indexOf(".html") > -1)
          var m = m.replace(/(-\d+)/g, "-{{#}}");
        c.length > 0 && ((r = !1), (l = !1), (d = !1)),
          s.infiniteScroll({
            path: m,
            append: "." + o,
            history: !1,
          ...
          s.on("append.infiniteScroll", function (e, a, s, r) {
            INSPIRO.slider.carousel(t(r).find(".carousel")),
              u.html(p),
              i.css("margin", "0 -" + n + "px -" + n + "px 0"),
              i.find("." + o).css("padding", "0 " + n + "px " + n + "px 0");
          });
      },
      tooltip: function () {
